								...
								<c:if test="${param.eid == n.id}">
									<tr>
										...
										<td class="title"><input type="text" name="title"
											value="${n.title}"> <span class="commentCount">${n.commentCount}</span>
											<input type="hidden" name="id" value="${n.id}"> <span><input
								...
								<c:if test="${param.id != n.id}">
									<tr>
										...
										<td class="title"><a href="detail?id=${n.id}">${n.title}</a>
											<span class="commentCount">${n.commentCount}</span> <span><a
